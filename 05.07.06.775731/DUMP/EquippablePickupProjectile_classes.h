...
struct AEquippablePickupProjectile_C : AAresDroppedEquippable {
	...
	void StopGunSkinVO(struct UAresAudioComponent* AresAudioComponent, struct AGun_C* Gun, struct UAudBasePawnVOComponent_C* AudBasePawnVOComponent); // Function EquippablePickupProjectile.EquippablePickupProjectile_C.StopGunSkinVO // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3511190
	...
	void ReceiveBeginPlay(); // Function EquippablePickupProjectile.EquippablePickupProjectile_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x3511190
	...
	void AuthInitialize(struct AAresEquippable* DroppedEquippable, struct FVector DropVector); // Function EquippablePickupProjectile.EquippablePickupProjectile_C.AuthInitialize // (BlueprintAuthorityOnly|Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x3511190
	void ReceiveTick(float DeltaSeconds); // Function EquippablePickupProjectile.EquippablePickupProjectile_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x3511190
	void ExecuteUbergraph_EquippablePickupProjectile(int32_t EntryPoint); // Function EquippablePickupProjectile.EquippablePickupProjectile_C.ExecuteUbergraph_EquippablePickupProjectile // (Final|UbergraphFunction|HasDefaults) // @ game+0x3511190
};
