...
struct UDirectConnectWidget_C : UUserWidget {
	...
	void SetGUID(struct FString Team, struct FString Player); // Function DirectConnectWidget.DirectConnectWidget_C.SetGUID // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3511190
	void GetConnectSettings(struct FDirectConnectSettings& Settings); // Function DirectConnectWidget.DirectConnectWidget_C.GetConnectSettings // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3511190
	void PopulateCachedSettings(struct FDirectConnectSettings Settings); // Function DirectConnectWidget.DirectConnectWidget_C.PopulateCachedSettings // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3511190
	void BndEvt__Port_K2Node_ComponentBoundEvent_98_OnEditableTextChangedEvent__DelegateSignature(struct FText& Text); // Function DirectConnectWidget.DirectConnectWidget_C.BndEvt__Port_K2Node_ComponentBoundEvent_98_OnEditableTextChangedEvent__DelegateSignature // (HasOutParms|BlueprintEvent) // @ game+0x3511190
	...
	void BndEvt__Button_K2Node_ComponentBoundEvent_1_OnPressed__DelegateSignature(struct USharedSecondaryButtonText_C* TextButton); // Function DirectConnectWidget.DirectConnectWidget_C.BndEvt__Button_K2Node_ComponentBoundEvent_1_OnPressed__DelegateSignature // (BlueprintEvent) // @ game+0x3511190
	void Construct(); // Function DirectConnectWidget.DirectConnectWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3511190
	...
	void ExecuteUbergraph_DirectConnectWidget(int32_t EntryPoint); // Function DirectConnectWidget.DirectConnectWidget_C.ExecuteUbergraph_DirectConnectWidget // (Final|UbergraphFunction|HasDefaults) // @ game+0x3511190
};
