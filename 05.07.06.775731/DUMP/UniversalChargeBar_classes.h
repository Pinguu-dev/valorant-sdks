...
struct UUniversalChargeBar_C : UUserWidget {
	...
	void SetChargePercent(float ChargePercent); // Function UniversalChargeBar.UniversalChargeBar_C.SetChargePercent // (BlueprintCallable|BlueprintEvent) // @ game+0x3511190
	void SetTopText(struct FText InText); // Function UniversalChargeBar.UniversalChargeBar_C.SetTopText // (BlueprintCallable|BlueprintEvent) // @ game+0x3511190
	void SetDividers(int32_t Dividers); // Function UniversalChargeBar.UniversalChargeBar_C.SetDividers // (BlueprintCallable|BlueprintEvent) // @ game+0x3511190
	void SetFillColor(struct FLinearColor InColor); // Function UniversalChargeBar.UniversalChargeBar_C.SetFillColor // (BlueprintCallable|BlueprintEvent) // @ game+0x3511190
	void ExecuteUbergraph_UniversalChargeBar(int32_t EntryPoint); // Function UniversalChargeBar.UniversalChargeBar_C.ExecuteUbergraph_UniversalChargeBar // (Final|UbergraphFunction|HasDefaults) // @ game+0x3511190
};
