...
struct ABombDetonationActor_TwoStage_C : ABombDetonationActor_C {
	...
	void ReceiveBeginPlay(); // Function BombDetonationActor_TwoStage.BombDetonationActor_TwoStage_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x3322f00
	...
	void ReceiveTick(float DeltaSeconds); // Function BombDetonationActor_TwoStage.BombDetonationActor_TwoStage_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x3322f00
	void OnCharacterKilledByBomb(struct AShooterCharacter* Character, struct UDamageResponse* Response); // Function BombDetonationActor_TwoStage.BombDetonationActor_TwoStage_C.OnCharacterKilledByBomb // (BlueprintCallable|BlueprintEvent) // @ game+0x3322f00
	void ExecuteUbergraph_BombDetonationActor_TwoStage(int32_t EntryPoint); // Function BombDetonationActor_TwoStage.BombDetonationActor_TwoStage_C.ExecuteUbergraph_BombDetonationActor_TwoStage // (Final|UbergraphFunction|HasDefaults) // @ game+0x3322f00
};
