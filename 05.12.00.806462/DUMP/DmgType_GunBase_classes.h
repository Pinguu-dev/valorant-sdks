...
struct UDmgType_GunBase_C : UDmgType_Base_C {
	...
	void MaybeSpawnFragileEffects(struct AShooterCharacter* VictimCharacter, struct UDamageResponse* DamageResponse); // Function DmgType_GunBase.DmgType_GunBase_C.MaybeSpawnFragileEffects // (Public|BlueprintCallable|BlueprintEvent|Const) // @ game+0x3322f00
	void MaybePlayFragileConfirm(struct AActor* HitActor, struct UDamageResponse* DamageResponse, enum class EAresHitConfirmLocality HitLocality, enum class EAresRegionalDamage RegionalDamage, bool CanSeeVictim, float FalloffMultiplier); // Function DmgType_GunBase.DmgType_GunBase_C.MaybePlayFragileConfirm // (Public|BlueprintCallable|BlueprintEvent|Const) // @ game+0x3322f00
	void PlayHitConfirmSound(struct AShooterCharacter* FirstPersonShooterCharacter, struct AShooterCharacter* ShooterCharacterInstigator, struct AActor* HitActor, enum class EAresHitConfirmLocality HitLocality, enum class EAresRegionalDamage RegionalDamage, bool bLocalPlayerCanSeeVictim, float FalloffMultiplier, struct UDamageResponse* DamageResponse, bool bDied); // Function DmgType_GunBase.DmgType_GunBase_C.PlayHitConfirmSound // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent|Const) // @ game+0x3322f00
};
