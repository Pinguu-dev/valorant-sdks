...
struct UComp_GameState_ExtraDebuffTags_C : UActorComponent {
	...
	void ReceiveBeginPlay(); // Function Comp_GameState_ExtraDebuffTags.Comp_GameState_ExtraDebuffTags_C.ReceiveBeginPlay // (Event|Public|BlueprintEvent) // @ game+0x3322f00
	void ExecuteUbergraph_Comp_GameState_ExtraDebuffTags(int32_t EntryPoint); // Function Comp_GameState_ExtraDebuffTags.Comp_GameState_ExtraDebuffTags_C.ExecuteUbergraph_Comp_GameState_ExtraDebuffTags // (Final|UbergraphFunction) // @ game+0x3322f00
};
