...
enum class EGameFeatureFloatConfigName : uint8 {
	...
	GamepadCrouchingSensitivityScale = 28,
	GamepadCrouchSensScaleEaseInOutTime = 29,
	GamepadShootingSensitivityScale = 30,
	GamepadShootSensScaleEaseInOutTime = 31,
	GamepadMaxFramerateAlways = 32,
	EndToEndLatencyJitter = 33,
	ABFootstepTestControlPercent = 34,
	RelativeTriggerThreshold = 35,
	RelativeTriggerDeltaSensitivity = 36,
	Count = 37,
	Invalid = 254,
...
enum class EAresFloatSettingName : uint8 {
	...
	GamepadBaseSpeedMultiplierXZoomed = 144,
	GamepadBaseSpeedMultiplierYZoomed = 145,
	GamepadMaxSpeedMultiplierXZoomed = 146,
	GamepadMaxSpeedMultiplierYZoomed = 147,
	GamepadMaxAccelerationThresholdZoomed = 148,
	GamepadAimAccelDelaySecondsZoomed = 149,
	GamepadAimAccelRampUpSecondsZoomed = 150,
	AimToolingAimAccelerationDelayDelayAmount = 151,
	AimToolingAimAccelerationDelayRampUpAmount = 152,
	ObserverRunSpeedModifier = 153,
	ObserverWalkSpeedModifier = 154,
	GyroShootingThresholdTap = 155,
	GyroShootingThresholdHold = 156,
	GyroShootingVisualBarMax = 157,
	GyroMovementWalkThresholdHorizontal = 158,
	GyroMovementWalkThresholdVertical = 159,
	GyroMovementRunThresholdHorizontal = 160,
	GyroMovementRunThresholdVertical = 161,
	GyroShotMovementDeadzoneThreshold = 162,
	GyroShotMovementDeadzoneValue = 163,
	EAresFloatSettingName_MAX = 164
};
...
enum class EAresIntSettingName : uint8 {
	...
	TouchDoubleTapRight = 67,
	TouchHUDPreset = 68,
	TouchDoubleTapLeft = 69,
	TouchAimAccelerationCurveX = 70,
	TouchAimAccelerationCurveY = 71,
	TouchAimADSAccelerationCurveX = 72,
	TouchAimADSAccelerationCurveY = 73,
	TouchAimSniperAccelerationCurveX = 74,
	TouchAimSniperAccelerationCurveY = 75,
	TouchJoystickStyle = 76,
	TouchSniperZoomLevelSetting = 77,
	TouchOperatorZoomCycleStyle = 78,
	TouchOperatorZoomCycleStyle_CachedAllLevels = 79,
	TouchOperatorZoomCycleStyle_CachedLevelOne = 80,
	TouchOperatorZoomCycleStyle_CachedLevelTwo = 81,
	TouchAimSensitivityPreset = 82,
	TouchGyroSensitivityPreset = 83,
	TouchTrackballSensitivityPreset = 84,
	TouchDoubleTapTopLeft = 85,
	TouchDoubleTapTopMiddle = 86,
	TouchDoubleTapTopRight = 87,
	TouchDoubleTapMiddleLeft = 88,
	TouchDoubleTapMiddle = 89,
	TouchDoubleTapMiddleRight = 90,
	TouchDoubleTapBottomLeft = 91,
	TouchDoubleTapBottomMiddle = 92,
	TouchDoubleTapBottomRight = 93,
	TouchNumVerticalRegions = 94,
	TouchNumHorizontalRegions = 95,
	MaxFramerateInBuyPhase = 96,
	MaxFramerateInGamePhase = 97,
	MaxFramerateInSpectatorView = 98,
	LastSeenRoamingSettingsVersion = 99,
	EAresIntSettingName_MAX = 100
};
...
enum class EAresBoolSettingName : uint8 {
	...
	GamepadEnableAnalogMoveThresholds = 138,
	GamepadToggleDropSpikeHold = 139,
	MultithreadedRenderingEnabled = 140,
	HasEverStartedAMatch = 141,
	HasAcceptedCodeOfConduct = 142,
	HasSeenNewPlayerSettings = 143,
	HasSeenNPEContractTutorial = 144,
	HasSeenUPWTutorial = 145,
	HasSeenSettingsTutorial = 146,
	HasSeenWelcomeScreen = 147,
	HasSeenMenuTutorial = 148,
	HasSeenPhotoSensitivityWarning = 149,
	HasSeenTournamentsScreen = 150,
	HasSeenXGPActivationModal = 151,
	CollectionShowOwnedOnly = 152,
	IncognitoHideMatchmadePlayerNames = 153,
	IncognitoRejectFriendRequests = 154,
	IncognitoRejectPartyInvitesByDisplayName = 155,
	PlayerBehavior_MuteEnemyTextChat = 156,
	PlayerBehavior_MuteObserverTextChat = 157,
	HideUI = 158,
	HideCrosshair = 159,
	Hide1P = 160,
	ObserversSeeBlinds = 161,
	TeamColorAffectsHUD = 162,
	ShowKeybindsOnMinimap = 163,
	ShowKeybindsOnMegamap = 164,
	FullscreenMegamap = 165,
	HandednessByTeam = 166,
	HideSpectatedAgentPortrait = 167,
	ObserverToggleScoreboard = 168,
	TriggerSwapAll = 169,
	HasEverAppliedRoamingSettings = 170,
	GyroTapShoot = 171,
	GyroShootingAxisSwap = 172,
	GyroShootingAxisInvert = 173,
	GyroShootingDisplayBar = 174,
	GyroMovementAxisInvertVertical = 175,
	GyroMovementAxisInvertHorizontal = 176,
	EAresBoolSettingName_MAX = 177
};
...
struct FClientPerRoundPerformanceData {
	...
	struct FAresObjectMetrics ObjectMetrics; // 0x530(0x64)
...
struct FClientEndOfRoundPerformanceProfile {
	...
	struct FAresObjectMetrics ObjectMetrics; // 0x49c(0x64)
	struct FClientFrameBuckets FrameBuckets; // 0x500(0x24)
	char pad_524[0x4]; // 0x524(0x04)
	struct FString MatchID; // 0x528(0x10)
	int32_t RoundNumber; // 0x538(0x04)
	char pad_53C[0x4]; // 0x53c(0x04)
	int64_t RoundDuration; // 0x540(0x08)
	struct FString InstanceId; // 0x548(0x10)
	struct FPerfSettings Settings; // 0x558(0x50)
	struct FMachinePerfStats MachinePerfStats; // 0x5a8(0x64)
	char MoveTimestepsPerSecond; // 0x60c(0x01)
	char pad_60D[0x3]; // 0x60d(0x03)
	struct FNetworkPacketStats NetworkPacketStats; // 0x610(0x54)
	char pad_664[0x4]; // 0x664(0x04)
	struct FNetworkLatencyStats NetworkLatencyStats; // 0x668(0x70)
	struct FString Puuid; // 0x6d8(0x10)
	struct FTelemetryPlatformInfo PlatformInfo; // 0x6e8(0x20)
};
...
struct FServerRoundMetrics {
	...
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x98(0x474)
	struct FServerFrameBuckets FrameBuckets; // 0x50c(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x528(0x64)
};
...
struct FServerPerRoundPerformanceData {
	...
	struct FAresObjectMetrics ObjectMetrics; // 0x528(0x64)
	int32_t ConcurrentServers; // 0x58c(0x04)
	float MaxTickRate; // 0x590(0x04)
	char MoveTimestepsPerSecond; // 0x594(0x01)
	char pad_595[0x3]; // 0x595(0x03)
};

// ScriptStruct ShooterGame.ServerEndOfRoundPerformanceProfile
// Size: 0x608 (Inherited: 0x00)
struct FServerEndOfRoundPerformanceProfile {
	...
	struct FAresObjectMetrics ObjectMetrics; // 0x4c4(0x64)
	struct FServerFrameBuckets FrameBuckets; // 0x528(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x544(0x64)
	char MoveTimestepsPerSecond; // 0x5a8(0x01)
	char pad_5A9[0x3]; // 0x5a9(0x03)
	float MaxTickRate; // 0x5ac(0x04)
	struct FNetworkPacketStats NetworkPacketStats; // 0x5b0(0x54)
