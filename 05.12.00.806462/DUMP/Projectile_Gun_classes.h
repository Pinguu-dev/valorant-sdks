...
struct AProjectile_Gun_C : AProjectile {
	...
	void ReceiveBeginPlay(); // Function Projectile_Gun.Projectile_Gun_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x3322f00
	void OnStopEvent_Event_1(); // Function Projectile_Gun.Projectile_Gun_C.OnStopEvent_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x3322f00
	void ExecuteUbergraph_Projectile_Gun(int32_t EntryPoint); // Function Projectile_Gun.Projectile_Gun_C.ExecuteUbergraph_Projectile_Gun // (Final|UbergraphFunction) // @ game+0x3322f00
};
