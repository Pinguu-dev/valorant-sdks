...
struct AFXC_RadianiteBombKill_C : AEffectContainer {
	...
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function FXC_RadianiteBombKill.FXC_RadianiteBombKill_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x32f73d0
	void UpdateEffectPerspective(float CurrentTime, bool FirstPerson); // Function FXC_RadianiteBombKill.FXC_RadianiteBombKill_C.UpdateEffectPerspective // (Event|Public|BlueprintEvent) // @ game+0x32f73d0
	void ExecuteUbergraph_FXC_RadianiteBombKill(int32_t EntryPoint); // Function FXC_RadianiteBombKill.FXC_RadianiteBombKill_C.ExecuteUbergraph_FXC_RadianiteBombKill // (Final|UbergraphFunction) // @ game+0x32f73d0
};
