...
enum class EGameFeatureToggleName : uint8 {
	...
	AudioVisualizationLOS = 145,
	AudioVisualizationMaterialFootstep = 146,
	MultichannelAudioVisualization = 147,
	ReplicationSleepFix = 148,
	RevertMobileFiringError = 149,
	CancelUsableOnServerCorrect = 150,
	ProjectileBendingV2 = 151,
	BurstFire = 152,
	BuffDamageRefactor = 153,
	MinimapPauseUnseenEnemyUpdates = 154,
	SkyeSeekerRefactor = 155,
	SageWallFindFloorUsingCapsuleSweep = 156,
	UseFireButtonManager = 157,
	ActorDormancyRespectsRelevancy = 158,
	BufferedZoomStates = 159,
	PODetection = 160,
	Count = 161,
	Invalid = 254,
...
enum class EAresFloatSettingName : uint8 {
	...
	TouchJoystickFollowDistance = 109,
	TouchJoystickOneEuroMinCutoff = 110,
	TouchJoystickOneEuroCutoffSlope = 111,
	TouchJoystickOneEuroDeltaCutoff = 112,
	GamepadBaseRotationSpeedX = 113,
	GamepadBaseRotationSpeedY = 114,
	GamepadLookStickSensitivityScopedMultiplier = 115,
	GamepadLookStickSensitivityADSMultiplier = 116,
	GamepadBaseSpeedMultiplierX = 117,
	GamepadBaseSpeedMultiplierY = 118,
	GamepadMaxSpeedMultiplierX = 119,
	GamepadMaxSpeedMultiplierY = 120,
	GamepadMaxAccelerationThreshold = 121,
	GamepadAimAccelDelaySeconds = 122,
	GamepadAimAccelRampUpSeconds = 123,
	GamepadLookStickInnerDeadzone = 124,
	GamepadLookStickOuterDeadzone = 125,
	GamepadLookStickAngularInnerDeadzoneDeg = 126,
	GamepadLookStickAngularOuterDeadzoneDeg = 127,
	GamepadWalkStickInnerDeadzone = 128,
	GamepadWalkStickAngularInnerDeadzoneDeg = 129,
	GamepadWalkStickAngularOuterDeadzoneDeg = 130,
	GamepadTriggerDeadzone = 131,
	GamepadAnalogWalkThreshold = 132,
	GamepadBaseSpeedMultiplierXZoomed = 133,
	GamepadBaseSpeedMultiplierYZoomed = 134,
	GamepadMaxSpeedMultiplierXZoomed = 135,
	GamepadMaxSpeedMultiplierYZoomed = 136,
	GamepadMaxAccelerationThresholdZoomed = 137,
	GamepadAimAccelDelaySecondsZoomed = 138,
	GamepadAimAccelRampUpSecondsZoomed = 139,
	AimToolingAimAccelerationDelayDelayAmount = 140,
	AimToolingAimAccelerationDelayRampUpAmount = 141,
	ObserverRunSpeedModifier = 142,
	ObserverWalkSpeedModifier = 143,
	GyroShootingThresholdDown = 144,
	GyroMovementWalkThresholdHorizontal = 145,
	GyroMovementWalkThresholdVertical = 146,
	GyroMovementRunThresholdHorizontal = 147,
	GyroMovementRunThresholdVertical = 148,
	GyroShotMovementDeadzoneThreshold = 149,
	GyroShotMovementDeadzoneValue = 150,
	EAresFloatSettingName_MAX = 151
};
...
enum class EAresBoolSettingName : uint8 {
	...
	HasSeenXGPActivationModal = 149,
	CollectionShowOwnedOnly = 150,
	IncognitoHideMatchmadePlayerNames = 151,
	IncognitoRejectFriendRequests = 152,
	IncognitoRejectPartyInvitesByDisplayName = 153,
	LastSeenSeasonalPopup = 154,
	...
	GyroMovementAxisInvertVertical = 173,
	GyroMovementAxisInvertHorizontal = 174,
	EAresBoolSettingName_MAX = 175
};
...
struct FClientEndOfRoundPerformanceProfile {
	...
	struct FPerfSettings Settings; // 0x558(0x48)
	struct FMachinePerfStats MachinePerfStats; // 0x5a0(0x64)
	char MoveTimestepsPerSecond; // 0x604(0x01)
	char pad_605[0x3]; // 0x605(0x03)
	struct FNetworkPacketStats NetworkPacketStats; // 0x608(0x54)
	char pad_65C[0x4]; // 0x65c(0x04)
	struct FNetworkLatencyStats NetworkLatencyStats; // 0x660(0x70)
	struct FString Puuid; // 0x6d0(0x10)
	struct FTelemetryPlatformInfo PlatformInfo; // 0x6e0(0x20)
};
