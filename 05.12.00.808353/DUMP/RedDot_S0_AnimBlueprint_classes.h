...
struct URedDot_S0_AnimBlueprint_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink& AnimGraph); // Function RedDot_S0_AnimBlueprint.RedDot_S0_AnimBlueprint_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function RedDot_S0_AnimBlueprint.RedDot_S0_AnimBlueprint_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x33231a0
	void ExecuteUbergraph_RedDot_S0_AnimBlueprint(int32_t EntryPoint); // Function RedDot_S0_AnimBlueprint.RedDot_S0_AnimBlueprint_C.ExecuteUbergraph_RedDot_S0_AnimBlueprint // (Final|UbergraphFunction) // @ game+0x33231a0
};
