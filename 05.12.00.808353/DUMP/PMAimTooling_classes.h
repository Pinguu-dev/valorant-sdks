...
struct UPMAimToolingComponent : UActorComponent {
	...
	bool IsFeatureEnabled(enum class EPMAimToolingFeature Feature); // Function PMAimTooling.PMAimToolingComponent.IsFeatureEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5613bf0
	bool IsAimToolingEnabled(); // Function PMAimTooling.PMAimToolingComponent.IsAimToolingEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5613bc0
	float GetFeatureConfig(enum class EPMAimToolingConfig ConfigName); // Function PMAimTooling.PMAimToolingComponent.GetFeatureConfig // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5613b30
};
