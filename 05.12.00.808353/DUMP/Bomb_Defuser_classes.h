...
struct ABomb_Defuser_C : AAresEquippable {
	...
	struct UBaseCrosshairHudElement* GetCurrentCrosshairHudElementClass(); // Function Bomb_Defuser.Bomb_Defuser_C.GetCurrentCrosshairHudElementClass // (Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const) // @ game+0x33231a0
	void ReceiveBeginPlay(); // Function Bomb_Defuser.Bomb_Defuser_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x33231a0
	void ExecuteUbergraph_Bomb_Defuser(int32_t EntryPoint); // Function Bomb_Defuser.Bomb_Defuser_C.ExecuteUbergraph_Bomb_Defuser // (Final|UbergraphFunction) // @ game+0x33231a0
};
