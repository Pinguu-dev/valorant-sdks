...
struct AFXC_Impact_Base_C : AEffectContainer {
	...
	void ResetEffect(); // Function FXC_Impact_Base.FXC_Impact_Base_C.ResetEffect // (Event|Public|BlueprintEvent) // @ game+0x33231a0
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function FXC_Impact_Base.FXC_Impact_Base_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x33231a0
	void ExecuteUbergraph_FXC_Impact_Base(int32_t EntryPoint); // Function FXC_Impact_Base.FXC_Impact_Base_C.ExecuteUbergraph_FXC_Impact_Base // (Final|UbergraphFunction|HasDefaults) // @ game+0x33231a0
};
