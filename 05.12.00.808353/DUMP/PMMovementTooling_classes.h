...
struct UPMMovementToolingComponent : UActorComponent {
	...
	bool IsMovementToolingEnabled(); // Function PMMovementTooling.PMMovementToolingComponent.IsMovementToolingEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2d20730
	bool IsFeatureEnabled(enum class EPMMovementToolingFeature Feature); // Function PMMovementTooling.PMMovementToolingComponent.IsFeatureEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x561ae20
	float GetFeatureConfig(enum class EPMMovementToolingConfig ConfigName); // Function PMMovementTooling.PMMovementToolingComponent.GetFeatureConfig // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x561ad90
};
