...
struct UHeadShotParticles_C : UUserWidget {
	...
	void SetColor(struct FLinearColor Color); // Function HeadShotParticles.HeadShotParticles_C.SetColor // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
	void BeginAnimation(); // Function HeadShotParticles.HeadShotParticles_C.BeginAnimation // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
};
