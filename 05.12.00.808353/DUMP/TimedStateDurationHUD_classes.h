...
struct UTimedStateDurationHUD_C : UCoordinatedHUDElement {
	...
	void SetUniveralChargeBarFillColor(struct FLinearColor InColor); // Function TimedStateDurationHUD.TimedStateDurationHUD_C.SetUniveralChargeBarFillColor // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
	void AdjustLayoutForDevice(struct FWidgetTransform InTransform); // Function TimedStateDurationHUD.TimedStateDurationHUD_C.AdjustLayoutForDevice // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
	...
	void ReadyForRemovalTimedState__DelegateSignature(); // Function TimedStateDurationHUD.TimedStateDurationHUD_C.ReadyForRemovalTimedState__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
};
