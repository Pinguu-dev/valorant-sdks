...
struct AFXC_Global_Reveal_C : AEffectContainer {
	...
	void ReceiveTick(float DeltaSeconds); // Function FXC_Global_Reveal.FXC_Global_Reveal_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x33231a0
	void ReceiveEndPlay(enum class EEndPlayReason EndPlayReason); // Function FXC_Global_Reveal.FXC_Global_Reveal_C.ReceiveEndPlay // (Event|Protected|BlueprintEvent) // @ game+0x33231a0
	void UpdateEffectPerspective(float CurrentTime, bool FirstPerson); // Function FXC_Global_Reveal.FXC_Global_Reveal_C.UpdateEffectPerspective // (Event|Public|BlueprintEvent) // @ game+0x33231a0
	void ResetEffect(); // Function FXC_Global_Reveal.FXC_Global_Reveal_C.ResetEffect // (Event|Public|BlueprintEvent) // @ game+0x33231a0
	void ManuallyUpdateEffectPerspective(bool FirstPerson); // Function FXC_Global_Reveal.FXC_Global_Reveal_C.ManuallyUpdateEffectPerspective // (BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
	void ExecuteUbergraph_FXC_Global_Reveal(int32_t EntryPoint); // Function FXC_Global_Reveal.FXC_Global_Reveal_C.ExecuteUbergraph_FXC_Global_Reveal // (Final|UbergraphFunction) // @ game+0x33231a0
};
