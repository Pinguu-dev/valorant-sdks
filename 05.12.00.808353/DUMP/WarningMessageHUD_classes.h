...
struct UWarningMessageHUD_C : UCoordinatedHUDElement {
	...
	void HideWarning(); // Function WarningMessageHUD.WarningMessageHUD_C.HideWarning // (BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
	void PlayOutro(); // Function WarningMessageHUD.WarningMessageHUD_C.PlayOutro // (BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
	void RemoveAfterAnim(); // Function WarningMessageHUD.WarningMessageHUD_C.RemoveAfterAnim // (BlueprintCallable|BlueprintEvent) // @ game+0x33231a0
	void ExecuteUbergraph_WarningMessageHUD(int32_t EntryPoint); // Function WarningMessageHUD.WarningMessageHUD_C.ExecuteUbergraph_WarningMessageHUD // (Final|UbergraphFunction|HasDefaults) // @ game+0x33231a0
};
