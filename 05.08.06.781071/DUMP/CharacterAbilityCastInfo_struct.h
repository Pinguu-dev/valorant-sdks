...
struct FCharacterAbilityCastInfo {
	...
	struct FVector EffectLocation_28_87E1E5154C2FB9C8A2D7FABF07AB5AF2; // 0x2c(0x0c)
	int32_t DestroyedCount_36_5936AB33418F8A2AB3A52DBF4492CF7F; // 0x38(0x04)
	char pad_3C[0x4]; // 0x3c(0x04)
	struct TArray<struct FCharacterAbilityEffectInfo> Effects_16_261D1D464B8B155AEE02A58E843AACB8; // 0x40(0x10)
};
