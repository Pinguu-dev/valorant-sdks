...
struct AGroundObjectMarker_C : AEffectContainer {
	...
	void MakeChatMessage(struct AEquippableGroundPickup_C* EquippableGroundPickup[, struct FText& ChatText); // Function GroundObjectMarker.GroundObjectMarker_C.MakeChatMessage // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void GetTextObjects(); // Function GroundObjectMarker.GroundObjectMarker_C.GetTextObjects // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void UserConstructionScript(); // Function GroundObjectMarker.GroundObjectMarker_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function GroundObjectMarker.GroundObjectMarker_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x3520f50
	void ReceiveTick(float DeltaSeconds); // Function GroundObjectMarker.GroundObjectMarker_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x3520f50
	void Got UI Data(struct UCharacterHandle* CharacterHandle); // Function GroundObjectMarker.GroundObjectMarker_C.Got UI Data // (BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void ExecuteUbergraph_GroundObjectMarker(int32_t EntryPoint); // Function GroundObjectMarker.GroundObjectMarker_C.ExecuteUbergraph_GroundObjectMarker // (Final|UbergraphFunction|HasDefaults) // @ game+0x3520f50
};
