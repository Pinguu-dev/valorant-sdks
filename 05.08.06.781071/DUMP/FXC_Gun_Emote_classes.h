...
struct AFXC_Gun_Emote_C : AEffectContainer {
	...
	void StopEffect(enum class EStopEffectType StopEffectType); // Function FXC_Gun_Emote.FXC_Gun_Emote_C.StopEffect // (Event|Public|BlueprintEvent) // @ game+0x3520f50
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function FXC_Gun_Emote.FXC_Gun_Emote_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x3520f50
	void ExecuteUbergraph_FXC_Gun_Emote(int32_t EntryPoint); // Function FXC_Gun_Emote.FXC_Gun_Emote_C.ExecuteUbergraph_FXC_Gun_Emote // (Final|UbergraphFunction) // @ game+0x3520f50
};
