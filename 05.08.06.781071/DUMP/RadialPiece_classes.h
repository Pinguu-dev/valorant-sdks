...
struct URadialPiece_C : UUserWidget {
	...
	bool IsHighlighted(float InMouseAngle, float InMouseDist); // Function RadialPiece.RadialPiece_C.IsHighlighted // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void Construct(); // Function RadialPiece.RadialPiece_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3520f50
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function RadialPiece.RadialPiece_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3520f50
	void ExecuteUbergraph_RadialPiece(int32_t EntryPoint); // Function RadialPiece.RadialPiece_C.ExecuteUbergraph_RadialPiece // (Final|UbergraphFunction|HasDefaults) // @ game+0x3520f50
};
