...
struct AFXC_SpeedBoostOrb_Applied_C : AEffectContainer {
	...
	void StopEffect(enum class EStopEffectType StopEffectType); // Function FXC_SpeedBoostOrb_Applied.FXC_SpeedBoostOrb_Applied_C.StopEffect // (Event|Public|BlueprintEvent) // @ game+0x3520f50
	void ExecuteUbergraph_FXC_SpeedBoostOrb_Applied(int32_t EntryPoint); // Function FXC_SpeedBoostOrb_Applied.FXC_SpeedBoostOrb_Applied_C.ExecuteUbergraph_FXC_SpeedBoostOrb_Applied // (Final|UbergraphFunction|HasDefaults) // @ game+0x3520f50
};
