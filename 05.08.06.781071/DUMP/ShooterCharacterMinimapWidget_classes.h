...
struct UShooterCharacterMinimapWidget_C : UShooterCharacterMinimapWidget {
	...
	void Voice Event(bool Speaking); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.Voice Event // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void Comm Event(enum class NonVerbalCommTypesEnum Nonverbal Comm); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.Comm Event // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void Set Slot From Config(struct FAresMinimapSlotConfig Config); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.Set Slot From Config // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void Update Missing Opacity(); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.Update Missing Opacity // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void Update Widget(); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.Update Widget // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void Construct(); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3520f50
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3520f50
	void ReceiveSetState(); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.ReceiveSetState // (Event|Public|BlueprintEvent) // @ game+0x3520f50
	void UpdateAccessibilityColors(enum class EAresIntSettingName SettingName, int32_t OldValue, int32_t NewValue); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.UpdateAccessibilityColors // (BlueprintCallable|BlueprintEvent) // @ game+0x3520f50
	void ExecuteUbergraph_ShooterCharacterMinimapWidget(int32_t EntryPoint); // Function ShooterCharacterMinimapWidget.ShooterCharacterMinimapWidget_C.ExecuteUbergraph_ShooterCharacterMinimapWidget // (Final|UbergraphFunction|HasDefaults) // @ game+0x3520f50
};
