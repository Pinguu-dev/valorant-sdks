...
enum class EAresFloatSettingName : uint8 {
	...
	GyroMovementWalkThresholdHorizontal = 140,
	GyroMovementWalkThresholdVertical = 141,
	GyroMovementRunThresholdHorizontal = 142,
	GyroMovementRunThresholdVertical = 143,
	EAresFloatSettingName_MAX = 144
};
...
enum class EAresBoolSettingName : uint8 {
	...
	GyroTapShoot = 169,
	GyroShootingAxisSwap = 170,
	GyroShootingAxisInvert = 171,
	GyroMovementAxisInvertVertical = 172,
	GyroMovementAxisInvertHorizontal = 173,
	EAresBoolSettingName_MAX = 174
};
...
// Enum ShooterGame.EPenaltyEffectState
enum class EPenaltyEffectState : uint8 {
	PenaltyApplied = 0,
	PenaltyReverted = 1,
	PenaltyExpired = 2,
	Count = 3,
	EPenaltyEffectState_MAX = 4
};
...
struct FPenaltyNotifyEffect {
	struct FString Subject; // 0x00(0x10)
	enum class EPenaltyEffectState EffectState; // 0x10(0x01)
	char pad_11[0x7]; // 0x11(0x07)
	struct FString Notification; // 0x18(0x10)
};
