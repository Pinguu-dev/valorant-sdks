...
struct U : UShooterCharacterMinimapWidget {
	...
	void (bool ); // Function ShooterCharacterMinimapWidget.. // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322a90
	void (enum class NonVerbalCommTypesEnum ); // Function ShooterCharacterMinimapWidget.. // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322a90
	void (struct FAresMinimapSlotConfig Config); // Function ShooterCharacterMinimapWidget.. // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322a90
	void (); // Function ShooterCharacterMinimapWidget.. // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322a90
	void (); // Function ShooterCharacterMinimapWidget.. // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322a90
	void Construct(); // Function ShooterCharacterMinimapWidget..Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3322a90
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function ShooterCharacterMinimapWidget..Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3322a90
	void ReceiveSetState(); // Function ShooterCharacterMinimapWidget..ReceiveSetState // (Event|Public|BlueprintEvent) // @ game+0x3322a90
	void (enum class EAresIntSettingName SettingName, int32_t OldValue, int32_t NewValue); // Function ShooterCharacterMinimapWidget.. // (BlueprintCallable|BlueprintEvent) // @ game+0x3322a90
	void (int32_t EntryPoint); // Function ShooterCharacterMinimapWidget.. // (Final|UbergraphFunction|HasDefaults) // @ game+0x3322a90
};
