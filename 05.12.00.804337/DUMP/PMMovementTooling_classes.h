...
struct UPMMovementToolingComponent : UActorComponent {
	...
	bool IsMovementToolingEnabled(); // Function PMMovementTooling.PMMovementToolingComponent.IsMovementToolingEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x2d20410
	bool IsFeatureEnabled(enum class EPMMovementToolingFeature Feature); // Function PMMovementTooling.PMMovementToolingComponent.IsFeatureEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x561a710
	float GetFeatureConfig(enum class EPMMovementToolingConfig ConfigName); // Function PMMovementTooling.PMMovementToolingComponent.GetFeatureConfig // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x561a680
};
