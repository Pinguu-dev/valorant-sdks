...
struct U : UMissingMinimapWidget {
	...
	void (); // Function MissingMinimapWidgetBase.. // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322a90
	void PreConstruct(bool IsDesignTime); // Function MissingMinimapWidgetBase..PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3322a90
	void Construct(); // Function MissingMinimapWidgetBase..Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3322a90
	void (int32_t EntryPoint); // Function MissingMinimapWidgetBase.. // (Final|UbergraphFunction) // @ game+0x3322a90
};
