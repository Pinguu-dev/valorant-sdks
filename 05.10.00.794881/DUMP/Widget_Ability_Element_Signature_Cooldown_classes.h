...
struct UWidget_Ability_Element_Signature_Cooldown_C : UWidget_Ability_Parent_C {
	...
	void OnStartWidget(); // Function Widget_Ability_Element_Signature_Cooldown.Widget_Ability_Element_Signature_Cooldown_C.OnStartWidget // (BlueprintCosmetic|Event|Protected|BlueprintEvent) // @ game+0x3307ac0
	void OnCooldownStarted_Event_1(); // Function Widget_Ability_Element_Signature_Cooldown.Widget_Ability_Element_Signature_Cooldown_C.OnCooldownStarted_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x3307ac0
	void Update Cooldown(); // Function Widget_Ability_Element_Signature_Cooldown.Widget_Ability_Element_Signature_Cooldown_C.Update Cooldown // (BlueprintCallable|BlueprintEvent) // @ game+0x3307ac0
	void ExecuteUbergraph_Widget_Ability_Element_Signature_Cooldown(int32_t EntryPoint); // Function Widget_Ability_Element_Signature_Cooldown.Widget_Ability_Element_Signature_Cooldown_C.ExecuteUbergraph_Widget_Ability_Element_Signature_Cooldown // (Final|UbergraphFunction|HasDefaults) // @ game+0x3307ac0
};
