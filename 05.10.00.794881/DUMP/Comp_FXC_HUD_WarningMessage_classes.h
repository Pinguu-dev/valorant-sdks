...
struct UComp_FXC_HUD_WarningMessage_C : UComp_FXC_HUD_C {
	...
	void SetupHUD_Event(struct UUserWidget* InHUD); // Function Comp_FXC_HUD_WarningMessage.Comp_FXC_HUD_WarningMessage_C.SetupHUD_Event // (BlueprintCallable|BlueprintEvent) // @ game+0x3307ac0
	void ExecuteUbergraph_Comp_FXC_HUD_WarningMessage(int32_t EntryPoint); // Function Comp_FXC_HUD_WarningMessage.Comp_FXC_HUD_WarningMessage_C.ExecuteUbergraph_Comp_FXC_HUD_WarningMessage // (Final|UbergraphFunction|HasDefaults) // @ game+0x3307ac0
};
