...
enum class EGameFeatureToggleName : uint8 {
	...
	DeathMatchPlayerSpawnedTelemetryEnabled = 127,
	...
	AudioVisualizationIconFootstep = 145,
	AudioVisualizationLOS = 146,
	AudioVisualizationMaterialFootstep = 147,
	MultichannelAudioVisualization = 148,
	ReplicationSleepFix = 149,
	RevertMobileFiringError = 150,
	CancelUsableOnServerCorrect = 151,
	ProjectileBendingV2 = 152,
	BurstFire = 153,
	BuffDamageRefactor = 154,
	MinimapPauseUnseenEnemyUpdates = 155,
	SkyeSeekerRefactor = 156,
	SageWallFindFloorUsingCapsuleSweep = 157,
	UseFireButtonManager = 158,
...
enum class EAresFloatSettingName : uint8 {
	...
	TouchJoystickWalkThreshold = 109,
	TouchJoystickRunLockThreshold = 110,
	TouchJoystickRunLockActivationAngleDeg = 111,
	TouchJoystickRunLockDisplayThreshold = 112,
	TouchJoystickFollowDistance = 113,
	TouchJoystickOneEuroMinCutoff = 114,
	TouchJoystickOneEuroCutoffSlope = 115,
	TouchJoystickOneEuroDeltaCutoff = 116,
	GamepadBaseRotationSpeedX = 117,
	GamepadBaseRotationSpeedY = 118,
	GamepadLookStickSensitivityScopedMultiplier = 119,
	GamepadLookStickSensitivityADSMultiplier = 120,
	GamepadBaseSpeedMultiplierX = 121,
	GamepadBaseSpeedMultiplierY = 122,
	GamepadMaxSpeedMultiplierX = 123,
	GamepadMaxSpeedMultiplierY = 124,
	GamepadMaxAccelerationThreshold = 125,
	GamepadAimAccelDelaySeconds = 126,
	GamepadAimAccelRampUpSeconds = 127,
	GamepadLookStickInnerDeadzone = 128,
	GamepadLookStickOuterDeadzone = 129,
	GamepadLookStickAngularInnerDeadzoneDeg = 130,
	GamepadLookStickAngularOuterDeadzoneDeg = 131,
	GamepadWalkStickInnerDeadzone = 132,
	GamepadWalkStickAngularInnerDeadzoneDeg = 133,
	GamepadWalkStickAngularOuterDeadzoneDeg = 134,
	GamepadTriggerDeadzone = 135,
	GamepadAnalogWalkThreshold = 136,
	GamepadBaseSpeedMultiplierXZoomed = 137,
	GamepadBaseSpeedMultiplierYZoomed = 138,
	GamepadMaxSpeedMultiplierXZoomed = 139,
	GamepadMaxSpeedMultiplierYZoomed = 140,
	GamepadMaxAccelerationThresholdZoomed = 141,
	GamepadAimAccelDelaySecondsZoomed = 142,
	GamepadAimAccelRampUpSecondsZoomed = 143,
	AimToolingAimAccelerationDelayDelayAmount = 144,
	AimToolingAimAccelerationDelayRampUpAmount = 145,
	ObserverRunSpeedModifier = 146,
	ObserverWalkSpeedModifier = 147,
	GyroShootingThresholdDown = 148,
	GyroShootingVisualBarMax = 149,
	GyroMovementWalkThresholdHorizontal = 150,
	GyroMovementWalkThresholdVertical = 151,
	GyroMovementRunThresholdHorizontal = 152,
	GyroMovementRunThresholdVertical = 153,
	GyroShotMovementDeadzoneThreshold = 154,
	GyroShotMovementDeadzoneValue = 155,
...
enum class EAresIntSettingName : uint8 {
	...
	TouchAimSensitivityPreset = 78,
	TouchGyroSensitivityPreset = 79,
	TouchTrackballSensitivityPreset = 80,
	TouchDoubleTapTopLeft = 81,
	TouchDoubleTapTopMiddle = 82,
	TouchDoubleTapTopRight = 83,
	TouchDoubleTapMiddleLeft = 84,
	TouchDoubleTapMiddle = 85,
	TouchDoubleTapMiddleRight = 86,
	TouchDoubleTapBottomLeft = 87,
	TouchDoubleTapBottomMiddle = 88,
	TouchDoubleTapBottomRight = 89,
	TouchNumVerticalRegions = 90,
	TouchNumHorizontalRegions = 91,
	MaxFramerateInBuyPhase = 92,
	MaxFramerateInGamePhase = 93,
	MaxFramerateInSpectatorView = 94,
	LastSeenRoamingSettingsVersion = 95,
	EAresIntSettingName_MAX = 96
};
...
enum class EAresBoolSettingName : uint8 {
	...
	TouchSniperCycleZoomOnHold = 127,
...
enum class EAbilityUsageLocationType : uint8 {
	CastLocation = 0,
	WallSegmentsSage = 1,
	EAbilityUsageLocationType_MAX = 2
};
