...
struct AFXC_Gun_Equip_C : AEffectContainer {
	...
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function FXC_Gun_Equip.FXC_Gun_Equip_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x3307ac0
	void StopEffect(enum class EStopEffectType StopEffectType); // Function FXC_Gun_Equip.FXC_Gun_Equip_C.StopEffect // (Event|Public|BlueprintEvent) // @ game+0x3307ac0
	void ExecuteUbergraph_FXC_Gun_Equip(int32_t EntryPoint); // Function FXC_Gun_Equip.FXC_Gun_Equip_C.ExecuteUbergraph_FXC_Gun_Equip // (Final|UbergraphFunction) // @ game+0x3307ac0
};
