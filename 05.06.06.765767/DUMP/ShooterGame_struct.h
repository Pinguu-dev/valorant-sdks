...
enum class EGameFeatureToggleName : uint8 {
	...
	PrototypeStability = 54,
	TencentSecuritySDK = 55,
	StealthMovingTeleporterBeaconsCollide = 56,
	PlayerThroughWallClipping = 57,
	PlayerThroughWallBackClipping = 58,
	PlayerMultipleClipping = 59,
	...
	MobileGunStability = 87,
	GamepadFast180Turn = 88,
	FoWDebugCheats = 89,
	AgentMastery = 90,
	EnableSpawnPointLookAheadBox = 91,
	DeathDistanceScoring = 92,
	ScoreLowVisibilityPointsMoreOften = 93,
	MoveProcessingDelayDebug = 94,
	SpawnPointLookAheadDynamicAdjustment = 95,
	UseMegamapTextureOverrides = 96,
	AllowQueueingEquippableChangesWhileUsing = 97,
	NVCUpdates = 98,
	RazeUltAutoEquipFix = 99,
	RationalMoveQueueTarget = 100,
	EnableWeaponBasedAbilityQueueing = 101,
	SprayV2 = 102,
	WheelShowupDelay = 103,
	SeparateQuickSpray = 104,
	ProportionalTimeShiftRate = 105,
	ForceTickAllAnimationPerspectives = 106,
	InteractableUserComponentCorrectionTimeout = 107,
	CleanPlayerStateOnDisassociate = 108,
	MoveSyncedUsables = 109,
	OverQueuedRebasing = 110,
	PureImpactEffects = 111,
	FXCPerspectiveUpdateFix = 112,
	EnableCypherGameObject = 113,
	FireButtonCustomization = 114,
	DevOnlyShop = 115,
	ServerValidateClientPredcitedUsables = 116,
	EnableJumpCrouch = 117,
	ChamberTPDeathBehaviorFix = 118,
	ReplicatedStateTransitionContext = 119,
	AllowGameplayTagFastReplication = 120,
	MoveDistributionTargeting = 121,
	EQSClearSpotForCharacterOverlapOffsetFix = 122,
	UseClientLocationForShots = 123,
	EnableGameplayFlagsTelemetry = 124,
	LineupCompass = 125,
	LineupOverlay = 126,
	RPCValidationWithDisconnect = 127,
	SendPerRoundNetworkTelemetryEvents = 128,
	DeathMatchLogPlayerSpawn = 129,
	AccurateWallMeshSeams = 130,
	LiveDiagnostics = 131,
	FXCInitialReplicationFix = 132,
	RemoteClientQueueSizeTrackingFix = 133,
	RoundEndMulticastBugfix = 134,
	ExpandedGestures = 135,
	SyncedTimerAuthStartUseCurrentTimestamp = 136,
	DeathPuckSizeAdjustment = 137,
	GyroShooting = 138,
	IsStealthedForActorRefactor = 139,
	CustomCombatTrackerSupport = 140,
	UseAbilityTrackingComponent = 141,
	RestoreSetReplicatesRGIs = 142,
	FixActorComponentBlockingDormancy = 143,
	GyroMovement = 144,
	RelativeTriggerEnabled = 145,
	AudioVisualization = 146,
	ReplicationSleepFix = 147,
	RevertMobileFiringError = 148,
	CancelUsableOnServerCorrect = 149,
	Count = 150,
	Invalid = 254,
...
enum class EGameRuleBoolName : uint8 {
	...
	AimToolingShotRooting = 20,
	AimToolingOverTargetAcceleration = 21,
	AimToolingAimAccelerationDelay = 22,
	AimToolingDeceleration = 23,
	MovementToolingModule = 24,
	MovementToolingShotRooting = 25,
	MovementToolingFastStrafing = 26,
	MovementToolingFastRelease = 27,
	MovementToolingAngularDeadzones = 28,
	MovementToolingRadialDeadzones = 29,
	PipAbilityCasting = 30,
	CombatReportOnlyShowLastLife = 31,
	MobileDefaultFoV = 32,
	UsePrototypePurchasables = 33,
	MobileDesignPrototype = 34,
	FootstepABTest = 35,
	UseAllAbilityCooldowns = 36,
	DownedCharactersCanGiveUp = 37,
	SpawnTurtleProtection = 38,
	Count = 39,
	Invalid = 254,
...
enum class EGameFeatureFloatConfigName : uint8 {
	...
	GamepadFast180TurnAimAccelDelayScale = 25,
	GamepadFast180TurnAimAccelRampUpScale = 26,
	EndToEndLatencyJitter = 27,
	ABFootstepTestControlPercent = 28,
	RelativeTriggerThreshold = 29,
	RelativeTriggerDeltaSensitivity = 30,
	Count = 31,
	Invalid = 254,
...
enum class EAresFloatSettingName : uint8 {
	...
	GamepadBaseRotationSpeedX = 106,
	GamepadBaseRotationSpeedY = 107,
	GamepadLookStickSensitivityScopedMultiplier = 108,
	GamepadBaseSpeedMultiplierX = 109,
	GamepadBaseSpeedMultiplierY = 110,
	GamepadMaxSpeedMultiplierX = 111,
	GamepadMaxSpeedMultiplierY = 112,
	GamepadMaxAccelerationThreshold = 113,
	GamepadAimAccelDelaySeconds = 114,
	GamepadAimAccelRampUpSeconds = 115,
	GamepadLookStickInnerDeadzone = 116,
	GamepadLookStickOuterDeadzone = 117,
	GamepadLookStickAngularInnerDeadzoneDeg = 118,
	GamepadLookStickAngularOuterDeadzoneDeg = 119,
	GamepadWalkStickInnerDeadzone = 120,
	GamepadWalkStickAngularInnerDeadzoneDeg = 121,
	GamepadWalkStickAngularOuterDeadzoneDeg = 122,
	GamepadTriggerDeadzone = 123,
	GamepadAnalogWalkThreshold = 124,
	GamepadBaseSpeedMultiplierXZoomed = 125,
	GamepadBaseSpeedMultiplierYZoomed = 126,
	GamepadMaxSpeedMultiplierXZoomed = 127,
	GamepadMaxSpeedMultiplierYZoomed = 128,
	GamepadMaxAccelerationThresholdZoomed = 129,
	GamepadAimAccelDelaySecondsZoomed = 130,
	GamepadAimAccelRampUpSecondsZoomed = 131,
	AimToolingAimAccelerationDelayDelayAmount = 132,
	AimToolingAimAccelerationDelayRampUpAmount = 133,
	ObserverRunSpeedModifier = 134,
	ObserverWalkSpeedModifier = 135,
	GyroShootingThresholdDown = 136,
	GyroShootingThresholdUp = 137,
	GyroShootingAccumulationThreshold = 138,
	GyroMovementAccumulationThresholdHorizontal = 139,
	GyroMovementAccumulationThresholdVertical = 140,
	GyroMovementWalkThresholdHorizontal = 141,
	GyroMovementWalkThresholdVertical = 142,
	GyroMovementRunThresholdHorizontal = 143,
	GyroMovementRunThresholdVertical = 144,
	EAresFloatSettingName_MAX = 145
};
...
enum class ECapID : uint8 {
	...
	GamepassEntitlementTypeID = 23,
	CurrencyRewardTypeID = 24,
	ContractXPCurrencyID = 25,
	F2PEntitlementTypeID = 26,
	Count = 27,
	ECapID_MAX = 28
};
...
enum class EEquippableSkinLevelItem : uint8 {
	...
	EEquippableSkinLevelItem_MAX = 14
};
...
enum class EWidgetLayoutSettingName : uint8 {
	...
	WS_MeleeWidth = 24,
	HideWhenInactive = 25,
	EWidgetLayoutSettingName_MAX = 26
};
...
struct FAccountXPMatch {
	struct FGuid ID; // 0x00(0x10)
	struct FDateTime MatchStart; // 0x10(0x08)
	struct FAccountXPPlayerProgress StartProgress; // 0x18(0x08)
	struct FAccountXPPlayerProgress EndProgress; // 0x20(0x08)
	int32_t XPDelta; // 0x28(0x04)
	char pad_2C[0x4]; // 0x2c(0x04)
	struct TArray<struct FAccountXPXPSource> XPSources; // 0x30(0x10)
	struct TArray<struct FAccountXPXPMultiplier> XPMultipliers; // 0x40(0x10)
};
...
struct FPremierRoster {
	struct FString ID; // 0x00(0x10)
	int64_t LeaguePoints; // 0x10(0x08)
...
struct FGetStorefrontRequest {
	struct FString UserInfoToken; // 0x00(0x10)
};
...
struct FCreateOrderRequest {
	...
	struct FString UserInfoToken; // 0x70(0x10)
	struct FOrderMetadata MetaData; // 0x80(0x80)
};
