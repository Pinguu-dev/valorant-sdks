...
enum class EGameFeatureToggleName : uint8 {
	...
	PlayerCorpseClipping = 59,
	GameDataEventPipelineRefactor = 60,
	RoundRestore = 61,
	MatchRecovery = 62,
	Hovercards = 63,
	ModesToggleA = 64,
	ModesToggleB = 65,
	ModesToggleC = 66,
	MobileLimitedSkinLoading = 67,
	RoamingSettingsLocalCache = 68,
	MovementSyncAllDamageResponses = 69,
	HideCharacterMeshesWhileRespawning = 70,
	DeathCamNearSightFix = 71,
	BurstWeaponsInstantAccuracyFix = 72,
	AgentSpecificKeybinds = 73,
	EnableCharacterScaling = 74,
	Totems = 75,
	RequestStopOnNotRelevant = 76,
	FXCPoolWarming = 77,
	TopHUDV2 = 78,
	PlayerInputConsumptionFix = 79,
	MultipleProjectileTuning = 80,
	ReplaySystem = 81,
	ReflexLatencyAnalyzer = 82,
	FoWAlwaysRelevantRuleUpdate = 83,
	FoWExpireViewerCacheDuringPreround = 84,
	EnableDynamicSpawnAlternateRotations = 85,
	SpawnAlternateRotationsPathfindToNearestEnemy = 86,
	GamepadFast180Turn = 87,
	FoWDebugCheats = 88,
	AgentMastery = 89,
	EnableSpawnPointLookAheadBox = 90,
	DeathDistanceScoring = 91,
	ScoreLowVisibilityPointsMoreOften = 92,
	MoveProcessingDelayDebug = 93,
	SpawnPointLookAheadDynamicAdjustment = 94,
	UseMegamapTextureOverrides = 95,
	AllowQueueingEquippableChangesWhileUsing = 96,
	NVCUpdates = 97,
	RazeUltAutoEquipFix = 98,
	RationalMoveQueueTarget = 99,
	EnableWeaponBasedAbilityQueueing = 100,
	SprayV2 = 101,
	WheelShowupDelay = 102,
	SeparateQuickSpray = 103,
	ProportionalTimeShiftRate = 104,
	ForceTickAllAnimationPerspectives = 105,
	InteractableUserComponentCorrectionTimeout = 106,
	CleanPlayerStateOnDisassociate = 107,
	MoveSyncedUsables = 108,
	OverQueuedRebasing = 109,
	PureImpactEffects = 110,
	FXCPerspectiveUpdateFix = 111,
	EnableCypherGameObject = 112,
	FireButtonCustomization = 113,
	DevOnlyShop = 114,
	ServerValidateClientPredcitedUsables = 115,
	EnableJumpCrouch = 116,
	ChamberTPDeathBehaviorFix = 117,
	ReplicatedStateTransitionContext = 118,
	AllowGameplayTagFastReplication = 119,
	MoveDistributionTargeting = 120,
	EQSClearSpotForCharacterOverlapOffsetFix = 121,
	UseClientLocationForShots = 122,
	EnableGameplayFlagsTelemetry = 123,
	LineupCompass = 124,
	LineupOverlay = 125,
	RPCValidationWithDisconnect = 126,
	SendPerRoundNetworkTelemetryEvents = 127,
	DeathMatchPlayerSpawnedTelemetryEnabled = 128,
	AccurateWallMeshSeams = 129,
	LiveDiagnostics = 130,
	FXCInitialReplicationFix = 131,
	RemoteClientQueueSizeTrackingFix = 132,
	RoundEndMulticastBugfix = 133,
	ExpandedGestures = 134,
	SyncedTimerAuthStartUseCurrentTimestamp = 135,
	DeathPuckSizeAdjustment = 136,
	GyroShooting = 137,
	IsStealthedForActorRefactor = 138,
	CustomCombatTrackerSupport = 139,
	UseAbilityTrackingComponent = 140,
	RestoreSetReplicatesRGIs = 141,
	FixActorComponentBlockingDormancy = 142,
	GyroMovement = 143,
	RelativeTriggerEnabled = 144,
	AudioVisualization = 145,
	AudioVisualizationIconFootstep = 146,
	AudioVisualizationLOS = 147,
	AudioVisualizationMaterialFootstep = 148,
	MultichannelAudioVisualization = 149,
	ReplicationSleepFix = 150,
	RevertMobileFiringError = 151,
	CancelUsableOnServerCorrect = 152,
	ProjectileBendingV2 = 153,
	BurstFire = 154,
	BuffDamageRefactor = 155,
	MinimapPauseUnseenEnemyUpdates = 156,
	SkyeSeekerRefactor = 157,
	SageWallFindFloorUsingCapsuleSweep = 158,
	ActorDormancyRespectsRelevancy = 159,
	BufferedZoomStates = 160,
	PODetection = 161,
	ExpireFoWCacheOnRoundBegin = 162,
	MobileAllySendRateLimiting = 163,
	MovementSyncDoor = 164,
	PremiumContentToggle0 = 165,
	PremiumContentToggle1 = 166,
	PremiumContentToggle2 = 167,
	PremiumContentToggle3 = 168,
	PremiumContentToggle4 = 169,
	PremiumContentToggle5 = 170,
	PremiumContentToggle6 = 171,
	PremiumContentToggle7 = 172,
	PremiumContentToggle8 = 173,
	PremiumContentToggle9 = 174,
	GradualMovementCorrections = 175,
	DebugMenuEnabledDefault = 176,
	UseMeshMaterialManager = 177,
	OmenCustomEQS = 178,
	OmenWallToggle = 179,
	Count = 180,
	Invalid = 254,
...
enum class EGameRuleBoolName : uint8 {
	...
	AimToolingAimAccelerationDelay = 20,
	AimToolingDeceleration = 21,
	AimToolingFrameOfReference = 22,
	AimToolingStrafeAssist = 23,
	AimToolingTargetFriction = 24,
	AimToolingFlashTurning = 25,
	MovementToolingModule = 26,
	MovementToolingShotRooting = 27,
	MovementToolingFastStrafing = 28,
	MovementToolingFastRelease = 29,
	MovementToolingAngularDeadzones = 30,
	MovementToolingRadialDeadzones = 31,
	MovementToolingAxialDeadzones = 32,
...
enum class EGameFeatureFloatConfigName : uint8 {
	...
	GamepadRecoilRecoveryMultiplier = 24,
	GamepadFast180TurnActivationThreshold = 25,
	GamepadFastTurningAimAccelDelayScale = 26,
	GamepadFastTurningAimAccelRampUpScale = 27,
	GamepadMaxFramerateAlways = 28,
	EndToEndLatencyJitter = 29,
	ABFootstepTestControlPercent = 30,
	RelativeTriggerThreshold = 31,
	RelativeTriggerDeltaSensitivity = 32,
	Count = 33,
	Invalid = 254,
...
enum class ERosterPartyMemberEligibility : uint8 {
	...
	Invalid = 3,
	ERosterPartyMemberEligibility_MAX = 4
};
...
enum class EAresFloatSettingName : uint8 {
	...
	TouchJoystickInnerDeadzone = 106,
	TouchJoystickAngularInnerDeadzoneDeg = 107,
	TouchJoystickAngularOuterDeadzoneDeg = 108,
	TouchJoystickAxialHorizontalDeadzone = 109,
	TouchJoystickAxialVerticalDeadzone = 110,
	TouchJoystickWalkThreshold = 111,
	TouchJoystickRunLockThreshold = 112,
	TouchJoystickRunLockActivationAngleDeg = 113,
	TouchJoystickRunLockDisplayThreshold = 114,
	TouchJoystickFollowDistance = 115,
	TouchJoystickOneEuroMinCutoff = 116,
	TouchJoystickOneEuroCutoffSlope = 117,
	TouchJoystickOneEuroDeltaCutoff = 118,
	TouchSniperHoldCyclingSpeed = 119,
	GamepadBaseRotationSpeedX = 120,
	GamepadBaseRotationSpeedY = 121,
	GamepadLookStickSensitivityScopedMultiplier = 122,
	GamepadLookStickSensitivityADSMultiplier = 123,
	GamepadBaseSpeedMultiplierX = 124,
	GamepadBaseSpeedMultiplierY = 125,
	GamepadMaxSpeedMultiplierX = 126,
	GamepadMaxSpeedMultiplierY = 127,
	GamepadMaxAccelerationThreshold = 128,
	GamepadAimAccelDelaySeconds = 129,
	GamepadAimAccelRampUpSeconds = 130,
	GamepadLookStickInnerDeadzone = 131,
	GamepadLookStickOuterDeadzone = 132,
	GamepadLookStickAngularInnerDeadzoneDeg = 133,
	GamepadLookStickAngularOuterDeadzoneDeg = 134,
	GamepadLookStickAxialHorizontalDeadzone = 135,
	GamepadLookStickAxialVerticalDeadzone = 136,
	GamepadWalkStickInnerDeadzone = 137,
	GamepadWalkStickAngularInnerDeadzoneDeg = 138,
	GamepadWalkStickAngularOuterDeadzoneDeg = 139,
	GamepadWalkStickAxialHorizontalDeadzone = 140,
	GamepadWalkStickAxialVerticalDeadzone = 141,
	GamepadTriggerDeadzone = 142,
	GamepadAnalogWalkThreshold = 143,
	GamepadCrouchingSensitivityScale = 144,
	GamepadCrouchSensScaleEaseInOutTime = 145,
	GamepadShootingSensitivityScale = 146,
	GamepadShootSensScaleEaseInOutTime = 147,
	GamepadBaseSpeedMultiplierXZoomed = 148,
	GamepadBaseSpeedMultiplierYZoomed = 149,
	GamepadMaxSpeedMultiplierXZoomed = 150,
	GamepadMaxSpeedMultiplierYZoomed = 151,
	GamepadMaxAccelerationThresholdZoomed = 152,
	GamepadAimAccelDelaySecondsZoomed = 153,
	GamepadAimAccelRampUpSecondsZoomed = 154,
	AimToolingAimAccelerationDelayDelayAmount = 155,
	AimToolingAimAccelerationDelayRampUpAmount = 156,
	ObserverRunSpeedModifier = 157,
	ObserverWalkSpeedModifier = 158,
	GyroShootingThresholdTap = 159,
	GyroShootingThresholdHold = 160,
	GyroShootingVisualBarMax = 161,
	GyroMovementWalkThresholdHorizontal = 162,
	GyroMovementWalkThresholdVertical = 163,
	GyroMovementRunThresholdHorizontal = 164,
	GyroMovementRunThresholdVertical = 165,
	GyroShotMovementDeadzoneThreshold = 166,
	GyroShotMovementDeadzoneValue = 167,
	EAresFloatSettingName_MAX = 168
};
...
enum class EAresIntSettingName : uint8 {
	...
	PlayerPerfShowRHIPresentTime = 36,
	PlayerPerfShowRemoteInterpDelayMs = 37,
	PlayerPerfShowQueuedRemoteMoveCount = 38,
	PlayerPerfShowConsecutiveRemoteForwardPredictions = 39,
	PlayerPerfShowPacketsLostIncoming = 40,
	PlayerPerfShowPacketsLostOutgoing = 41,
	PlayerPerfShowUploadedData = 42,
	PlayerPerfShowDownloadedData = 43,
	PlayerPerfShowTotalTransferredData = 44,
	PlayerPerfShowIncomingPacketSize = 45,
	PlayerPerfShowOutgoingPacketSize = 46,
	PlayerPerfShowMoveCorrectionDistance = 47,
	PlayerPerfShowMoveTimelineShiftMs = 48,
	PlayerPerfShowReceivedEquippableCorrection = 49,
	PlayerPerfShowOutgoingInputQueueLength = 50,
	PlayerPerfShowOutgoingMoveQueueLength = 51,
	PlayerPerfShowClientIncomingMoveProcessingDelay = 52,
	PlayerPerfShowServerIncomingMoveProcessingDelay = 53,
	PlayerPerfShowATB = 54,
	PlayerPerfShowNetworkJitter = 55,
	PlayerPerfShowEndToEndLatency = 56,
	PlayerPerfShowFiringErrors = 57,
	PlayerPerf_LastSetting = 58,
	NetworkSmoothing = 59,
	ShootingRangeSkillTestSetting = 60,
	ShootingRangePlantModuleDifficultySetting = 61,
	ShootingRangeDefuseModuleDifficultySetting = 62,
	GamepadSavedPreset = 63,
	GamepadSavedAimCurve = 64,
	GamepadSavedAimCurveZoomed = 65,
	GamepadSavedAimCurveAngularDeadzone = 66,
	GamepadAnalogMoveThresholdMode = 67,
	TouchDoubleTapRight = 68,
	TouchHUDPreset = 69,
	TouchDoubleTapLeft = 70,
	TouchAimAccelerationCurveX = 71,
	TouchAimAccelerationCurveY = 72,
	TouchAimADSAccelerationCurveX = 73,
	TouchAimADSAccelerationCurveY = 74,
	TouchAimSniperAccelerationCurveX = 75,
	TouchAimSniperAccelerationCurveY = 76,
	TouchJoystickStyle = 77,
	TouchSniperZoomLevelSetting = 78,
	TouchOperatorZoomCycleStyle = 79,
	TouchOperatorZoomCycleStyle_CachedAllLevels = 80,
	TouchOperatorZoomCycleStyle_CachedLevelOne = 81,
	TouchOperatorZoomCycleStyle_CachedLevelTwo = 82,
	TouchAimSensitivityPreset = 83,
	TouchGyroSensitivityPreset = 84,
	TouchTrackballSensitivityPreset = 85,
	TouchDoubleTapTopLeft = 86,
	TouchDoubleTapTopMiddle = 87,
	TouchDoubleTapTopRight = 88,
	TouchDoubleTapMiddleLeft = 89,
	TouchDoubleTapMiddle = 90,
	TouchDoubleTapMiddleRight = 91,
	TouchDoubleTapBottomLeft = 92,
	TouchDoubleTapBottomMiddle = 93,
	TouchDoubleTapBottomRight = 94,
	TouchNumVerticalRegions = 95,
	TouchNumHorizontalRegions = 96,
	MaxFramerateInBuyPhase = 97,
	MaxFramerateInGamePhase = 98,
	MaxFramerateInSpectatorView = 99,
	LastSeenRoamingSettingsVersion = 100,
	EAresIntSettingName_MAX = 101
};
...
enum class EAresBoolSettingName : uint8 {
	...
	TouchMovementUncrouchOnRun = 118,
	TouchAbilityMapRotation = 119,
	TouchEnableAutoRun = 120,
	TouchAutoRunEquipsKnife = 121,
	TouchCrosshairHighlightEnabled = 122,
	TouchSprintInputFromBottomOnly = 123,
	ToughMagnetismEnabled = 124,
	TouchRunBuffer = 125,
	TouchAimSnappingEnabled = 126,
	TouchMarshalCycleZoomOnHold = 127,
	TouchTrackballEnableLinearDrag = 128,
	TouchQuickCastingEnabled = 129,
	TouchJoystickFollowHorizontalOnly = 130,
	GamepadInvertLookStickY = 131,
	GamepadInvertLookStickX = 132,
	GamepadToggleCrouch = 133,
	GamepadToggleWalk = 134,
	GamepadDefaultToWalk = 135,
	GamepadHoldInputForADS = 136,
	GamepadHoldInputForScope = 137,
	GamepadToggleDropSpikeHold = 138,
	MultithreadedRenderingEnabled = 139,
	HasEverStartedAMatch = 140,
	HasAcceptedCodeOfConduct = 141,
	HasSeenNewPlayerSettings = 142,
	HasSeenNPEContractTutorial = 143,
	HasSeenUPWTutorial = 144,
	HasSeenSettingsTutorial = 145,
	HasSeenWelcomeScreen = 146,
	HasSeenMenuTutorial = 147,
	HasSeenPhotoSensitivityWarning = 148,
	HasSeenTournamentsScreen = 149,
	HasSeenXGPActivationModal = 150,
	CollectionShowOwnedOnly = 151,
	IncognitoHideMatchmadePlayerNames = 152,
	IncognitoRejectFriendRequests = 153,
	IncognitoRejectPartyInvitesByDisplayName = 154,
	PlayerBehavior_MuteEnemyTextChat = 155,
	PlayerBehavior_MuteObserverTextChat = 156,
	HideUI = 157,
	HideCrosshair = 158,
	Hide1P = 159,
	ObserversSeeBlinds = 160,
	TeamColorAffectsHUD = 161,
	ShowKeybindsOnMinimap = 162,
	ShowKeybindsOnMegamap = 163,
	FullscreenMegamap = 164,
	HandednessByTeam = 165,
	HideSpectatedAgentPortrait = 166,
	ObserverToggleScoreboard = 167,
	TriggerSwapAll = 168,
	HasEverAppliedRoamingSettings = 169,
	GyroTapShoot = 170,
	GyroShootingAxisSwap = 171,
	GyroShootingAxisInvert = 172,
	GyroShootingDisplayBar = 173,
	GyroMovementAxisInvertVertical = 174,
	GyroMovementAxisInvertHorizontal = 175,
	EAresBoolSettingName_MAX = 176
};
...
enum class EAresStringSettingName : uint8 {
	...
	LastSeenAdHocPopup = 16,
	PreferredGamePods = 17,
	TouchWidgetLayouts = 18,
	TouchCrosshairHighlightColor = 19,
	MutedWords = 20,
	EAresStringSettingName_MAX = 21
};
...
enum class ERosterInviteErrorType : uint8 {
	RosterLocked = 0,
	InviteeMaxRosterLimitReached = 1,
	Default = 2,
	Count = 3,
	Invalid = 4,
	ERosterInviteErrorType_MAX = 5
};
...
enum class EJoystickStyle : uint8 {
	FloatingFollowing = 0,
	Floating = 1,
	FixedFollowing = 2,
	Fixed = 3,
	Absolute = 4,
	EJoystickStyle_MAX = 5
};
...
// Enum ShooterGame.EAresButtonStyleStates
enum class EAresButtonStyleStates : uint8 {
	Default = 0,
	Disabled = 1,
	Pressed = 2,
	Hovered = 3,
	Equipped = 4,
	EAresButtonStyleStates_MAX = 5
};
...
// Enum ShooterGame.ERiotNativePlatformLoginStrategy
enum class ERiotNativePlatformLoginStrategy : uint8 {
	PS4 = 0,
	None = 1,
	ERiotNativePlatformLoginStrategy_MAX = 2
};
...
// Enum ShooterGame.ERiotNativePlatformLoginStatusState
enum class ERiotNativePlatformLoginStatusState : uint8 {
	Uninitialized = 0,
	Initialized = 1,
	Authenticating = 2,
	Cancelled = 3,
	...
	Error = 5,
	Unknown = 6,
	ERiotNativePlatformLoginStatusState_MAX = 7
};
...
enum class EAresMainMenuTopNavigationState : uint8 {
	...
	Rewards = 18,
	None = 19,
	EAresMainMenuTopNavigationState_MAX = 20
};
...
enum class EPlatformInitErrorReason : uint8 {
	...
	Count = 84,
	EPlatformInitErrorReason_MAX = 85
};
...
enum class EPlayerPerfMetricCategory : uint8 {
	...
	RHIPresentTime = 22,
	RemoteInterpDelayMs = 23,
	QueuedRemoteMoveCount = 24,
	ConsecutiveForwardPredictionTicks = 25,
	UploadedData = 26,
	DownloadedData = 27,
	TotalTransferredData = 28,
	InPacketSize = 29,
	OutPacketSize = 30,
	MoveCorrectionDistance = 31,
	MoveTimelineShiftMs = 32,
	ReceivedEquippableCorrection = 33,
	OutgoingInputQueueLength = 34,
	OutgoingMoveQueueLength = 35,
	ClientIncomingMoveProcessingDelay = 36,
	ServerIncomingMoveProcessingDelay = 37,
	ATB = 38,
	NetworkJitter = 39,
	FullEndToEndLatency = 40,
	FiringError = 41,
	EnumCount = 42,
	EPlayerPerfMetricCategory_MAX = 43
};
...
enum class EAresPartyTournamentStartAvailability : uint8 {
	...
	Unavailable_Unqualified = 5,
	Available_PartyLeader = 6,
	Available_NotPartyLeader = 7,
	TournamentStarted = 8,
	EAresPartyTournamentStartAvailability_MAX = 9
};
...
enum class EAbilityUsageLocationType : uint8 {
	...
	EAbilityUsageLocationType_MAX = 4
};
...
struct FTournamentData {
	...
	struct TArray<struct FIneligibleRosterPartyMember> IneligibleRosterPartyMembers; // 0x20(0x10)
};
...
// ScriptStruct ShooterGame.PremierEventEligibility
// Size: 0x38 (Inherited: 0x00)
struct FPremierEventEligibility {
	struct FString RosterID; // 0x00(0x10)
	struct FString EventID; // 0x10(0x10)
	struct FString EventType; // 0x20(0x10)
	bool PointEligibilityStatus; // 0x30(0x01)
	char pad_31[0x7]; // 0x31(0x07)
};
...
struct FEquippableAimToolingModifiers {
	...
	struct FString TuningTagHipfire; // 0x08(0x10)
	struct FString TuningTagADS; // 0x18(0x10)
};
...
struct FAresSystemTelemetryMetrics {
	...
	struct FMetric Esports; // 0x104(0x14)
	struct FMetric Esports_Other; // 0x118(0x14)
	struct FMetric FogOfWar; // 0x12c(0x14)
	struct FMetric FogOfWar_Visibility; // 0x140(0x14)
	struct FMetric FogOfWar_Manager; // 0x154(0x14)
	struct FMetric FogOfWar_Component; // 0x168(0x14)
	struct FMetric FogOfWar_Other; // 0x17c(0x14)
	struct FMetric Gameplay; // 0x190(0x14)
	struct FMetric Gameplay_GameMode; // 0x1a4(0x14)
	struct FMetric Gameplay_GameState; // 0x1b8(0x14)
	struct FMetric Gameplay_PlayerState; // 0x1cc(0x14)
	struct FMetric Gameplay_Controller; // 0x1e0(0x14)
	struct FMetric Gameplay_Audio; // 0x1f4(0x14)
	struct FMetric Gameplay_Minimap; // 0x208(0x14)
	struct FMetric Gameplay_Other; // 0x21c(0x14)
	struct FMetric Movement; // 0x230(0x14)
	struct FMetric Movement_Other; // 0x244(0x14)
	struct FMetric Network; // 0x258(0x14)
	struct FMetric Network_StreamComponent; // 0x26c(0x14)
	struct FMetric Network_OodleNetwork; // 0x280(0x14)
	struct FMetric Network_Other; // 0x294(0x14)
	struct FMetric Particles; // 0x2a8(0x14)
	struct FMetric Particles_Other; // 0x2bc(0x14)
	struct FMetric Physics; // 0x2d0(0x14)
	struct FMetric Physics_Other; // 0x2e4(0x14)
	struct FMetric Render; // 0x2f8(0x14)
	struct FMetric Render_Sync; // 0x30c(0x14)
	struct FMetric Render_TextureStreaming; // 0x320(0x14)
	struct FMetric Render_UI; // 0x334(0x14)
	struct FMetric Render_Other; // 0x348(0x14)
	struct FMetric Replication; // 0x35c(0x14)
	struct FMetric Replication_Other; // 0x370(0x14)
	struct FMetric Idle; // 0x384(0x14)
	struct FMetric Other; // 0x398(0x14)
	struct FMetric Other_ActorTick; // 0x3ac(0x14)
	struct FMetric Other_ComponentTick; // 0x3c0(0x14)
	struct FMetric Other_GameObjectTick; // 0x3d4(0x14)
	struct FMetric Other_GarbageCollection; // 0x3e8(0x14)
	struct FMetric Other_WorldTick; // 0x3fc(0x14)
	struct FMetric Other_TickPreRTG; // 0x410(0x14)
	struct FMetric Other_TickPostRTG; // 0x424(0x14)
	struct FMetric Other_RunTickGroup; // 0x438(0x14)
	struct FMetric TempDebug; // 0x44c(0x14)
	struct FMetric TempDebug_SubOne; // 0x460(0x14)
	struct FMetric TempDebug_SubTwo; // 0x474(0x14)
	struct FMetric TempDebug_SubThree; // 0x488(0x14)
	struct FMetric TempDebug_Other; // 0x49c(0x14)
};
...
struct FAresObjectMetrics {
	...
	struct FMetric ActiveNetworkedObjectCount; // 0x3c(0x14)
	struct FMetric EnabledTickFunctionCount; // 0x50(0x14)
};
...
struct FClientFilteredPerformanceProfile {
	...
	struct FPerfSettings Settings; // 0x108(0x50)
};
...
struct FClientPerRoundPerformanceData {
	...
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x34(0x4b0)
	struct FClientFrameBuckets FrameBuckets; // 0x4e4(0x24)
	struct FMachinePerfStats MachinePerfStats; // 0x508(0x64)
	struct FAresObjectMetrics ObjectMetrics; // 0x56c(0x64)
	char MoveTimestepsPerSecond; // 0x5d0(0x01)
...
struct FClientEndOfRoundPerformanceProfile {
	...
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x28(0x4b0)
	struct FAresObjectMetrics ObjectMetrics; // 0x4d8(0x64)
	struct FClientFrameBuckets FrameBuckets; // 0x53c(0x24)
	struct FString MatchID; // 0x560(0x10)
	int32_t RoundNumber; // 0x570(0x04)
	char pad_574[0x4]; // 0x574(0x04)
	int64_t RoundDuration; // 0x578(0x08)
	struct FString InstanceId; // 0x580(0x10)
	struct FPerfSettings Settings; // 0x590(0x50)
	struct FMachinePerfStats MachinePerfStats; // 0x5e0(0x64)
	char MoveTimestepsPerSecond; // 0x644(0x01)
	char pad_645[0x3]; // 0x645(0x03)
	struct FNetworkPacketStats NetworkPacketStats; // 0x648(0x54)
	char pad_69C[0x4]; // 0x69c(0x04)
	struct FNetworkLatencyStats NetworkLatencyStats; // 0x6a0(0x70)
	struct FString Puuid; // 0x710(0x10)
	struct FTelemetryPlatformInfo PlatformInfo; // 0x720(0x20)
};
...
struct FPlayerCardHandleLoadOptions {
	...
	bool bLoadLargeMaterialInterface; // 0x04(0x01)
	bool bLoadWideMaterialInterface; // 0x05(0x01)
	bool bLoadSmallMaterialInterface; // 0x06(0x01)
};
...
struct FStageLoadout {
	struct TMap<enum class EAresItemSlot, struct UAresPurchasableEquippable*> Loadout; // 0x00(0x50)
};
...
// ScriptStruct ShooterGame.RiotNativePlatformLoginStatus
// Size: 0x18 (Inherited: 0x00)
struct FRiotNativePlatformLoginStatus {
	bool IsReady; // 0x00(0x01)
	enum class ERiotNativePlatformLoginStatusState State; // 0x01(0x01)
	char pad_2[0x6]; // 0x02(0x06)
...
struct FAresParty {
	...
	struct FTournamentData TournamentData; // 0x180(0x30)
	struct FString ClientVersion; // 0x1b0(0x10)
	int64_t Version; // 0x1c0(0x08)
	bool LookingForMore; // 0x1c8(0x01)
	char pad_1C9[0x7]; // 0x1c9(0x07)
	struct FCheatData CheatData; // 0x1d0(0x18)
	struct TArray<struct FString> EligibleQueues; // 0x1e8(0x10)
	struct TArray<struct FPartyXPBonus> XPBonuses; // 0x1f8(0x10)
	struct FString State; // 0x208(0x10)
	struct FString PreviousState; // 0x218(0x10)
	enum class EAresPartyAccessibility Accessibility; // 0x228(0x01)
	char pad_229[0x7]; // 0x229(0x07)
	struct FString StateTransitionReason; // 0x230(0x10)
	struct TArray<struct FPartyInvite> Invites; // 0x240(0x10)
	struct TArray<struct FPartyRequest> Requests; // 0x250(0x10)
	struct FDateTime QueueEntryTime; // 0x260(0x08)
	struct FAresPartyErrorNotification ErrorNotification; // 0x268(0x20)
	int64_t RestrictedSeconds; // 0x288(0x08)
	struct TArray<struct FQueueIneligibility> QueueIneligibilities; // 0x290(0x10)
};
...
struct FServerRoundMetrics {
	...
	struct FAresObjectMetrics ObjectMetrics; // 0x34(0x64)
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x98(0x4b0)
	struct FServerFrameBuckets FrameBuckets; // 0x548(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x564(0x64)
};
...
struct FServerPerRoundPerformanceData {
	...
	struct FMetric ProcessingTime; // 0x20(0x14)
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x34(0x4b0)
	struct FServerFrameBuckets FrameBuckets; // 0x4e4(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x500(0x64)
	struct FAresObjectMetrics ObjectMetrics; // 0x564(0x64)
	int32_t ConcurrentServers; // 0x5c8(0x04)
	float MaxTickRate; // 0x5cc(0x04)
	char MoveTimestepsPerSecond; // 0x5d0(0x01)
	char pad_5D1[0x7]; // 0x5d1(0x07)
};
...
struct FServerEndOfRoundPerformanceProfile {
	...
	struct FMetric ProcessingTime; // 0x14(0x14)
	struct FAresSystemTelemetryMetrics SystemMetrics; // 0x28(0x4b0)
	struct FString MatchID; // 0x4d8(0x10)
	int32_t RoundNumber; // 0x4e8(0x04)
	char pad_4EC[0x4]; // 0x4ec(0x04)
	int64_t RoundDuration; // 0x4f0(0x08)
	int32_t ConcurrentServers; // 0x4f8(0x04)
	struct FAresObjectMetrics ObjectMetrics; // 0x4fc(0x64)
	struct FServerFrameBuckets FrameBuckets; // 0x560(0x1c)
	struct FMachinePerfStats MachinePerfStats; // 0x57c(0x64)
	char MoveTimestepsPerSecond; // 0x5e0(0x01)
	char pad_5E1[0x3]; // 0x5e1(0x03)
	float MaxTickRate; // 0x5e4(0x04)
	struct FNetworkPacketStats NetworkPacketStats; // 0x5e8(0x54)
...
struct FPlayerSpawnedEvent {
	...
	bool SpawnPointDataStale; // 0x9c(0x01)
	char pad_9D[0x3]; // 0x9d(0x03)
	float SpawnPointScore; // 0xa0(0x04)
	int32_t NumTicksUntilUpdate; // 0xa4(0x04)
	float LastUpdateTimestamp; // 0xa8(0x04)
	float CurrentTimestamp; // 0xac(0x04)
	uint32_t NumVisibleEnemyCharacters; // 0xb0(0x04)
	uint32_t NumAliveCharacters; // 0xb4(0x04)
	float LookAheadMultiplier; // 0xb8(0x04)
	char pad_BC[0x4]; // 0xbc(0x04)
	struct TArray<struct FNumSpawnsPerVisibilityScore> NumSpawnsPerVisibilityScore; // 0xc0(0x10)
	uint32_t NumStaleSpawnPoints; // 0xd0(0x04)
	char pad_D4[0x4]; // 0xd4(0x04)
	struct TArray<float> ConsideredSpawnPointScores; // 0xd8(0x10)
};
...
struct FAbilityUsageEvent {
	...
	struct FGameEventPlayerInfo PlayerInfo; // 0x90(0x60)
	struct FGameEventCharacterState PlayerState; // 0xf0(0x1a0)
	struct FAbilityUsageInfo AbilityInfo; // 0x290(0x68)
};
