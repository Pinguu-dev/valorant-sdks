...
struct AFXC_BombDetonation_TwoStage_C : AEffectContainer {
	...
	void ReceiveTick(float DeltaSeconds); // Function FXC_BombDetonation_TwoStage.FXC_BombDetonation_TwoStage_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x3352280
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function FXC_BombDetonation_TwoStage.FXC_BombDetonation_TwoStage_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x3352280
	void ExecuteUbergraph_FXC_BombDetonation_TwoStage(int32_t EntryPoint); // Function FXC_BombDetonation_TwoStage.FXC_BombDetonation_TwoStage_C.ExecuteUbergraph_FXC_BombDetonation_TwoStage // (Final|UbergraphFunction|HasDefaults) // @ game+0x3352280
};
