...
struct ABombDetonationActor_C : AGameObject {
	...
	void ReplicateBombHit(struct AShooterCharacter* HitCharacter); // Function BombDetonationActor.BombDetonationActor_C.ReplicateBombHit // (Net|NetReliableNetMulticast|BlueprintCallable|BlueprintEvent) // @ game+0x3352280
	void ReceiveTick(float DeltaSeconds); // Function BombDetonationActor.BombDetonationActor_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x3352280
	void ReceiveBeginPlay(); // Function BombDetonationActor.BombDetonationActor_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x3352280
	...
	void ExecuteUbergraph_BombDetonationActor(int32_t EntryPoint); // Function BombDetonationActor.BombDetonationActor_C.ExecuteUbergraph_BombDetonationActor // (Final|UbergraphFunction|HasDefaults) // @ game+0x3352280
};
