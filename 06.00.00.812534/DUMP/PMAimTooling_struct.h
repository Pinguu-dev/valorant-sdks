...
enum class EPMAimToolingConfig : uint8 {
	...
	AimAccelerationDelayScaleDecayRate = 13,
	AimAccelerationDelayMinOverTargetPct = 14,
	DecelerationTime = 15,
	DecelerationAverageWindow = 16,
	DecelerationExponent = 17,
	DecelerationHalfAngle = 18,
	DecelerationMaxShift = 19,
	DecelerationStartThreshold = 20,
	FlashTurningAimAccelerationScale = 21,
	FlashTurningPitchSensitivityScale = 22,
	FlashTurningYawSensitivityScale = 23,
	NoTargetFalloffTime = 24,
	Count = 25,
	Invalid = 254,
	EPMAimToolingFeature_MAX = 255,
...
// ScriptStruct PMAimTooling.PMAimToolingTargetFrictionFeatureTuningSet
// Size: 0x08 (Inherited: 0x00)
struct FPMAimToolingTargetFrictionFeatureTuningSet {
	struct FVector2D TargetFrictionStrengthScale; // 0x00(0x08)
};
