...
struct ABP_RopeAscender_C : AActor {
	...
	void HandleForceModuleRemoved(struct AShooterCharacter* Character); // Function BP_RopeAscender.BP_RopeAscender_C.HandleForceModuleRemoved // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3352280
	void HandleForceModuleAdded(struct AShooterCharacter* Character); // Function BP_RopeAscender.BP_RopeAscender_C.HandleForceModuleAdded // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3352280
	void ShouldRepelActor(struct AActor* ActorOnRope, struct AActor* CollidingActor, bool& bShouldRepel); // Function BP_RopeAscender.BP_RopeAscender_C.ShouldRepelActor // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x3352280
	void RecordAscenderUse(struct AShooterCharacter* Character); // Function BP_RopeAscender.BP_RopeAscender_C.RecordAscenderUse // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3352280
	...
	void OnRoundBegin_Event_1(int32_t RoundNumberBeginning); // Function BP_RopeAscender.BP_RopeAscender_C.OnRoundBegin_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x3352280
	void HandleCharacterCollision(struct UPrimitiveComponent* HitComponent, struct AActor* OtherActor, struct UPrimitiveComponent* OtherComp, struct FVector NormalImpulse, struct FHitResult& Hit); // Function BP_RopeAscender.BP_RopeAscender_C.HandleCharacterCollision // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x3352280
	void ReceiveBeginPlay(); // Function BP_RopeAscender.BP_RopeAscender_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x3352280
	void BndEvt__Usable_K2Node_ComponentBoundEvent_0_UsableComponentUseSuccessful__DelegateSignature(struct UInteractableUserComponent* User); // Function BP_RopeAscender.BP_RopeAscender_C.BndEvt__Usable_K2Node_ComponentBoundEvent_0_UsableComponentUseSuccessful__DelegateSignature // (BlueprintEvent) // @ game+0x3352280
	void OnTeleported_Event_1(struct AShooterCharacter* Character); // Function BP_RopeAscender.BP_RopeAscender_C.OnTeleported_Event_1 // (BlueprintCallable|BlueprintEvent) // @ game+0x3352280
	void ExecuteUbergraph_BP_RopeAscender(int32_t EntryPoint); // Function BP_RopeAscender.BP_RopeAscender_C.ExecuteUbergraph_BP_RopeAscender // (Final|UbergraphFunction|HasDefaults) // @ game+0x3352280
};
