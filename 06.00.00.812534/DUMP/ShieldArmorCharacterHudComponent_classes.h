...
struct UShieldArmorCharacterHudComponent_C : UCharacterHudComponent {
	...
	void GetCharacterHudDrawValues(struct FCharacterHudDrawValues& Out); // Function ShieldArmorCharacterHudComponent.ShieldArmorCharacterHudComponent_C.GetCharacterHudDrawValues // (Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const) // @ game+0x3352280
};
