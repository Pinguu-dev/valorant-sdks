...
struct UDebugAudioHUD_C : UAresHudElement {
	...
	void OnDraw(float DeltaTime); // Function DebugAudioHUD.DebugAudioHUD_C.OnDraw // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3322a60
	void (int32_t EntryPoint); // Function DebugAudioHUD.DebugAudioHUD_C. // (Final|UbergraphFunction|HasDefaults) // @ game+0x3322a60
};
