...
struct AFXC_ImpactMelee_Base_C : AEffectContainer {
	...
	void (float& ); // Function FXC_ImpactMelee_Base.FXC_ImpactMelee_Base_C. // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x3322a60
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function FXC_ImpactMelee_Base.FXC_ImpactMelee_Base_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x3322a60
	void (int32_t EntryPoint); // Function FXC_ImpactMelee_Base.FXC_ImpactMelee_Base_C. // (Final|UbergraphFunction|HasDefaults) // @ game+0x3322a60
};
