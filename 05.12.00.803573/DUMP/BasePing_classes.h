...
struct ABasePing_C : AEffectContainer {
	...
	bool (struct UObject* Object); // Function BasePing.BasePing_C. // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (struct FText& ); // Function BasePing.BasePing_C. // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (); // Function BasePing.BasePing_C. // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void UserConstructionScript(); // Function BasePing.BasePing_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (struct UCharacterHandle* CharacterHandle); // Function BasePing.BasePing_C. // (BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function BasePing.BasePing_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x3322a60
	void ReceiveTick(float DeltaSeconds); // Function BasePing.BasePing_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x3322a60
	void (); // Function BasePing.BasePing_C. // (BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (); // Function BasePing.BasePing_C. // (BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void ResetEffect(); // Function BasePing.BasePing_C.ResetEffect // (Event|Public|BlueprintEvent) // @ game+0x3322a60
	void (int32_t EntryPoint); // Function BasePing.BasePing_C. // (Final|UbergraphFunction|HasDefaults) // @ game+0x3322a60
};
