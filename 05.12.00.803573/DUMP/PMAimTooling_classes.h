...
struct UPMAimToolingComponent : UActorComponent {
	...
	bool IsFeatureEnabled(enum class EPMAimToolingFeature Feature); // Function PMAimTooling.PMAimToolingComponent.IsFeatureEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x56134b0
	bool IsAimToolingEnabled(); // Function PMAimTooling.PMAimToolingComponent.IsAimToolingEnabled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x5613480
	float GetFeatureConfig(enum class EPMAimToolingConfig ConfigName); // Function PMAimTooling.PMAimToolingComponent.GetFeatureConfig // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x56133f0
};
