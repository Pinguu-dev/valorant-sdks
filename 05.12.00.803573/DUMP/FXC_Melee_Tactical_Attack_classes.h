...
struct AFXC_Melee_Tactical_Attack_C : AFXC_Melee_Parent_C {
	struct UMeleeEffectComponent_C* MeleeEffectComponent; // 0x550(0x08)
	struct UPlayerMelee_Particle_Component_C* PlayerMelee_Particle_Component; // 0x558(0x08)
	struct UComp_FXC_AudioBasic_C* Comp_FXC_AudioBasic; // 0x560(0x08)
	struct UComp_FXC_PlayAnimation_ShooterCharacter_C* ; // 0x568(0x08)
};
