...
struct AProjectile_Gun_C : AProjectile {
	...
	struct UHitScanMovementComponent* ; // 0x4f8(0x08)
	...
	void ReceiveBeginPlay(); // Function Projectile_Gun.Projectile_Gun_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x3322a60
	void _1(); // Function Projectile_Gun.Projectile_Gun_C._1 // (BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (int32_t EntryPoint); // Function Projectile_Gun.Projectile_Gun_C. // (Final|UbergraphFunction) // @ game+0x3322a60
};
