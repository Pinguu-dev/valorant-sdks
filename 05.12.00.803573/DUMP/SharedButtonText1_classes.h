...
struct U : UDesignableUserWidget {
	...
	void (struct FText ButtonText); // Function SharedButtonText1.. // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (bool ); // Function SharedButtonText1.. // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (); // Function SharedButtonText1.. // (BlueprintEvent) // @ game+0x3322a60
	void (); // Function SharedButtonText1.. // (BlueprintEvent) // @ game+0x3322a60
	void Construct(); // Function SharedButtonText1..Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3322a60
	void (); // Function SharedButtonText1.. // (BlueprintEvent) // @ game+0x3322a60
	void (); // Function SharedButtonText1.. // (BlueprintEvent) // @ game+0x3322a60
	void OnSynchronizeProperties(); // Function SharedButtonText1..OnSynchronizeProperties // (Event|Public|BlueprintEvent) // @ game+0x3322a60
	void (int32_t EntryPoint); // Function SharedButtonText1.. // (Final|UbergraphFunction) // @ game+0x3322a60
	void (struct U* NewParam); // Function SharedButtonText1.. // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (struct U* ); // Function SharedButtonText1.. // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (struct U* ); // Function SharedButtonText1.. // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
	void (struct U* ); // Function SharedButtonText1.. // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x3322a60
};
