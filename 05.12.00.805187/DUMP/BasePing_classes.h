...
struct ABasePing_C : AEffectContainer {
	...
	bool GetIsMuted(struct UObject* Object); // Function BasePing.BasePing_C.GetIsMuted // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x3322b10
	void GenerateVOandChat(struct FText& ChatMessageText); // Function BasePing.BasePing_C.GenerateVOandChat // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x3322b10
	void GetTextObjects(); // Function BasePing.BasePing_C.GetTextObjects // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322b10
	void UserConstructionScript(); // Function BasePing.BasePing_C.UserConstructionScript // (Event|Public|BlueprintCallable|BlueprintEvent) // @ game+0x3322b10
	void I_GOT_DA_THING(struct UCharacterHandle* CharacterHandle); // Function BasePing.BasePing_C.I_GOT_DA_THING // (BlueprintCallable|BlueprintEvent) // @ game+0x3322b10
	void StartEffect(struct AActor* Target, struct UObject* Context, float StartTime, bool FirstPerson); // Function BasePing.BasePing_C.StartEffect // (Event|Public|BlueprintEvent) // @ game+0x3322b10
	void ReceiveTick(float DeltaSeconds); // Function BasePing.BasePing_C.ReceiveTick // (Event|Public|BlueprintEvent) // @ game+0x3322b10
	void OnCinemtaticModeChanged(); // Function BasePing.BasePing_C.OnCinemtaticModeChanged // (BlueprintCallable|BlueprintEvent) // @ game+0x3322b10
	void UpdateColors(); // Function BasePing.BasePing_C.UpdateColors // (BlueprintCallable|BlueprintEvent) // @ game+0x3322b10
	void ResetEffect(); // Function BasePing.BasePing_C.ResetEffect // (Event|Public|BlueprintEvent) // @ game+0x3322b10
	void ExecuteUbergraph_BasePing(int32_t EntryPoint); // Function BasePing.BasePing_C.ExecuteUbergraph_BasePing // (Final|UbergraphFunction|HasDefaults) // @ game+0x3322b10
};
