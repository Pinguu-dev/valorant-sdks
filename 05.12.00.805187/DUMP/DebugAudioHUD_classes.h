...
struct UDebugAudioHUD_C : UAresHudElement {
	...
	void OnDraw(float DeltaTime); // Function DebugAudioHUD.DebugAudioHUD_C.OnDraw // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x3322b10
	void ExecuteUbergraph_DebugAudioHUD(int32_t EntryPoint); // Function DebugAudioHUD.DebugAudioHUD_C.ExecuteUbergraph_DebugAudioHUD // (Final|UbergraphFunction|HasDefaults) // @ game+0x3322b10
};
